...
<nav class="navbar navbar-expand-lg dashboard-navbar sticky-top">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="home.php"><img src="assets/img/logo_herfa.png" alt="Logo" height="40" style="margin-right:0.8rem;"><span style="color:#F5ECD7;font-weight:700;font-size:1.3rem;">حرفة Tunisie</span></a>
...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        ...
        <a href="offres.php" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i>Retour aux offres</a>
    </div>
            ...
            <?php foreach ($applications as $app): ?>
                <div class="col-12">
                    <div class="app-card">
                        ...
                        <form method="post" action="update_application.php" class="d-flex flex-wrap gap-2 align-items-center">
                            ...
                            <a class="btn btn-outline-primary" href="profile.php?user_id=<?php echo (int)$app['id_user']; ?>"><i class="fas fa-id-card me-1"></i>Profil candidat</a>
                        </form>
                    </div>
                </div>
            <?php endforeach; ?>
