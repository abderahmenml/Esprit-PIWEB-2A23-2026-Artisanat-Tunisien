...
try {
    ...
    $offerWhere = $offerHasStatus ? " WHERE status IN ('active', 'actif', 'open')" : '';
...
$offerWhereSql = $offerHasStatus ? "WHERE o.status IN ('active', 'actif', 'open')" : '';
$offerOrderSql = $offerHasCreatedAt ? 'o.created_at DESC' : 'o.id_offer DESC';

$offersStmt = $pdo->query(
    "SELECT o.id_offer, o.titre, o.description, o.budget, o.duree, {$offerLocationSql}, {$offerCreatedAtSql},
        ...
        * {
        ...
        .hero-banner {
            background: linear-gradient(135deg, rgba(139, 90, 58, 0.85), rgba(46, 107, 62, 0.85)), 
                        url('assets/img/item_pics/IMG_3043.JPG');
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center gap-2">
                <li class="nav-item"><a class="nav-link active" href="home.php"><i class="fas fa-home me-1"></i>Accueil</a></li>
...
<section class="hero-banner">
    ...
    <div class="container">
        ...
        <div>
            <a href="projets.php" class="btn-cta"><i class="fas fa-rocket me-2"></i>Explorer les projets</a>
            <a href="profile.php" class="btn-cta btn-outline-cta"><i class="fas fa-user-edit me-2"></i>Compléter mon profil</a>
        </div>
    </div>
</section>
...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
        ...
        <a href="projets.php" class="btn btn-outline-success rounded-pill"><i class="fas fa-arrow-right me-2"></i>Voir tous</a>
    </div>
                    ...
                    <div class="project-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-auto">
                                ...
                                <a href="projets.php?id=<?php echo $proj['id']; ?>" class="btn btn-sm btn-success rounded-pill">En savoir plus <i class="fas fa-arrow-right ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4 mt-5">
        ...
        <a href="formations.php" class="btn btn-outline-success rounded-pill"><i class="fas fa-arrow-right me-2"></i>Voir toutes</a>
    </div>
                ...
                <div class="formation-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-auto">
                            ...
                            <a href="formations.php?id=<?php echo $form['id']; ?>" class="btn btn-sm btn-outline-success rounded-pill">S'inscrire</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4 mt-5">
        ...
        <a href="offres.php" class="btn btn-outline-success rounded-pill"><i class="fas fa-arrow-right me-2"></i>Voir toutes</a>
    </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="artisan-card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <a href="profile.php?user_id=<?php echo $art['id_user']; ?>" class="btn btn-sm btn-outline-success rounded-pill">Voir le profil</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
    ...
    <div class="user-section fade-in">
        ...
        <div class="text-center mt-3">
            <a href="my_applications.php" class="btn btn-sm btn-outline-success rounded-pill">Voir toutes mes candidatures</a>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="user-section fade-in">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="recruiter_dashboard.php?offer=<?php echo $offer['id_offer']; ?>" class="btn btn-sm btn-outline-success rounded-pill">Gérer</a></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <div class="text-center mt-3">
            <a href="create_offre.php" class="btn btn-success rounded-pill"><i class="fas fa-plus me-2"></i>Créer une nouvelle offre</a>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="cta-section">
        <div class="container">
            ...
            <div>
                <a href="profile.php" class="btn btn-light rounded-pill me-3" style="color: var(--primary-green);"><i class="fas fa-user-plus me-2"></i>Compléter mon profil</a>
                <a href="projets.php" class="btn btn-outline-light rounded-pill"><i class="fas fa-rocket me-2"></i>Explorer les projets</a>
            </div>
        </div>
    </div>
</div>
