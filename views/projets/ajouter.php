<?php
/**
 * Vue : Formulaire d'ajout d'un projet
 * Fichier : views/projets/ajouter.php
...
<head>
    ...
    <title>Ajouter un projet — CraftLink</title>
    <link rel="stylesheet" href="public/css/style.css">
    <style>
        body { font-family: 'DM Sans', sans-serif; background: #f5f3ef; margin: 0; }
        .container { max-width: 700px; margin: 40px auto; padding: 0 20px; }
        h1 { font-family: 'Playfair Display', serif; color: #2c2c2c; margin-bottom: 28px; }
...
<div class="container">
    ...
    <div class="card">
        ...
        <form action="index.php?page=projets_ajouter" method="POST">
                ...
                <select id="id_categorie" name="id_categorie"
                    ...
                    <?php foreach ($categories as $cat): ?>
                        <option value="<?= (int) $cat['id_categorie'] ?>"
                            <?= ((int)($old['id_categorie'] ?? 0) === (int) $cat['id_categorie']) ? 'selected' : '' ?>>
