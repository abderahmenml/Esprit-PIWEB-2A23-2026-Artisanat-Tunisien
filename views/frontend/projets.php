...
$allSkills = $pdo->query('SELECT nom_competence AS competence FROM competences ORDER BY nom_competence ASC')->fetchAll();
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center gap-2">
                ...
                <li class="nav-item"><a class="nav-link active" href="projets.php"><i class="fas fa-project-diagram me-1"></i>Projets</a></li>
