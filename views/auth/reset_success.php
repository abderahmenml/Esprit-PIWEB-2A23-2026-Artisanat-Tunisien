...
<head>
  ...
  <title>Mot de passe modifie - CraftLink</title>
...
<body>
  <div class="box">
    ...
    <p>Votre mot de passe a ete change avec succes.<br>Redirection vers la connexion...</p>
    <a class="btn" href="index.php?page=login">Aller a la connexion</a>
