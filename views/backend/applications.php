...
<head>
    ...
    <style>
        ...
        .hero-banner { background: linear-gradient(135deg, rgba(139, 90, 58, 0.72), rgba(46, 107, 62, 0.72)), url('<?php echo h($baseUrl . 'public/assets/img/item_pics/IMG_3043.JPG'); ?>'); background-size: cover; background-position: center; color: #F5ECD7; padding: 3.2rem 0; text-align: center; border-bottom: 5px solid #8B5A3A; margin-bottom: 2rem; }
...
<nav class="navbar navbar-expand-lg dashboard-navbar sticky-top">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="<?php echo h($baseUrl . 'controllers/home.php'); ?>"><img src="<?php echo h($baseUrl . 'public/assets/img/logo_herfa.png'); ?>" alt="Logo" height="40" style="margin-right:0.8rem;"><span style="color:#F5ECD7;font-weight:700;font-size:1.3rem;">حرفة Tunisie</span></a>
                ...
                <div class="col-12">
                    <div class="app-card">
                        <div class="d-flex justify-content-between flex-wrap gap-2">
                            ...
                            <span class="badge bg-<?php echo $app['status'] === 'accepted' ? 'success' : ($app['status'] === 'rejected' ? 'danger' : 'secondary'); ?> px-3 py-2"><?php echo h((string)$app['status']); ?></span>
                        </div>
                        <hr>
                        <p><strong>Lettre de motivation</strong><br><?php echo nl2br(h((string)$app['lettre_de_motivation'])); ?></p>
                        <p><strong>CV</strong><br><?php echo h((string)$app['cv']); ?></p>
